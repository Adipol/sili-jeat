<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="current_password" value="{{ __('Ingrese su Contraseña') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password" value="{{ __('Ingrese la nueva Contraseña') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="password_confirmation" value="{{ __('Confirme la nueva Contraseña') }}" />

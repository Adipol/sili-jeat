<div>
    ...
    @if ($other->link_others)
        <a class="btn btn-red" wire:click="download_others"><i class="fas fa-download"></i></a>
    @endif
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name='content'>
            <div class="mb-4">
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <x-jet-input wire:model="other.others" type="text" class="block w-full" />
                </div>
            </div>
        ...
        <x-slot name='footer'>
            ...
            <x-jet-danger-button wire:click="save_others" wire:loading.attr="disabled" class="disabled:opacity-25">
                Guardar
            </x-jet-danger-button>
        </x-slot>
    </x-jet-dialog-modal>

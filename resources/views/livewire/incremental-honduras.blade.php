                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="new_uk" class="block text-sm font-medium text-gray-700">Nuevo
                                    UK</label>
                                <input type="number" name="new_uk" id="new_uk" autocomplete="given-name"
                                    wire:model="new_uk"
                                    class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            <div class="col-span-6 sm:col-span-3">
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="@if($index % 2 === 0) bg-blue-50 @endif hover:bg-blue-100 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                            @livewire('incremental-original-csv-honduras', ['control' => $control], key('control-profile-two-' . $control->id))
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">

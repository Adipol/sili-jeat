<div>
                ...
                @foreach ($peps as $pep)
                    <tr>
                        ...
                        <td title="Detalle de la persona" style="width:5%">
                            @livewire('show-pep-guatemala', ['pep' => $pep], key('consul-profile-one-' . $pep->id_register))
                        </td>
                        <td style="width:5%" title="Imprimir detalle">
                            <a class="btn btn-red" href="{{ route('download-guatemala-pdf', $pep->id_register) }}">
                                <i class="fas fa-file-pdf"></i>
                            </a>
                        </td>
                        <td style="width:5%" title="Allegado">
                            @livewire('allegado-guatemala', ['pep' => $pep], key('consul-profile-two-' . $pep->id))
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @else
        <div class="px-6 py-4 text-center">
            ...
            <a class="btn btn-red" href="{{ route('download-pdf-null-guatemala') }}">
                Imprimir detalle
            </a>
        </div>
    @endif

<div>
    ...
    @if ($peps->count())
        <table class="min-w-full divide-y divide-gray-200">
            <!-- Cabecera con el color del navbar -->
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @foreach ($peps as $pep)
                    <tr class="hover:bg-gray-100">
                        ...
                        <td style="width:5%">
                            @livewire('show-pep-paraguay', ['pep' => $pep], key('consul-profile-one-' . $pep->id_register))
                        </td>
                        <td style="width:5%">
                            <a class="btn btn-red" href="{{ route('download-paraguay-pdf', $pep->id_register) }}">
                                <i class="fas fa-file-pdf"></i>
                            </a>
                        </td>
                        <td style="width:5%">
                            @livewire('allegado-paraguay', ['pep' => $pep], key('consul-profile-two-' . $pep->id))
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    @else
        <div class="px-6 py-4 text-center">
            ...
            <a class="btn btn-red" href="{{ route('download-pdf-null-paraguay') }}">
                Imprimir detalle
            </a>
        </div>
    @endif

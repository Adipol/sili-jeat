        ...
        <x-slot name="content">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="">
                    ...
                    <x-jet-input wire:model="pep.country" type="text" class="w-full readonly" />
                </div>
                <div>
                    <x-jet-label value="Departamento" />
                    <x-jet-input wire:model="pep.department" type="text" class="w-full readonly" />
                </div>
                <div>
                    <x-jet-label value="Municipio" />
                    <x-jet-input wire:model="pep.province" type="text" class="w-full readonly" />
                </div>
            </div>

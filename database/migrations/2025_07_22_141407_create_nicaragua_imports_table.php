...
class CreateNicaraguaImportsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('nicaragua_imports', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('europol_new')->nullable();
            $table->integer('canadienses_new')->nullable();
            $table->integer('ex_peps_new')->nullable();
            $table->integer('ipr_new')->nullable();
            $table->integer('dea_new')->nullable();
            $table->integer('upa_new')->nullable();
            ...
            $table->integer('europol_upgrade')->nullable();
            $table->integer('canadienses_upgrade')->nullable();
            $table->integer('ex_peps_upgrade')->nullable();
            $table->integer('ipr_upgrade')->nullable();
            $table->integer('dea_upgrade')->nullable();
            $table->integer('upa_upgrade')->nullable();
    ...
    {
        Schema::dropIfExists('nicaragua_imports');
    }
}

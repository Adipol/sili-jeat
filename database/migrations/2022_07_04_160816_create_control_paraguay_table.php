...
class CreateControlParaguayTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('control_paraguay', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('id_pep');
            $table->string('id_all')->nullable();
            $table->enum('type', [ControlParaguay::PEP, ControlParaguay::LISTA]);
    ...
    {
        Schema::dropIfExists('control_paraguay');
    }
}

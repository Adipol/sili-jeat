...
class CreateControlNicaraguaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('control_nicaragua', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('id_pep');
            $table->string('id_all')->nullable();
            $table->enum('type', [ControlNicaragua::PEP, ControlNicaragua::LISTA]);
    ...
    {
        Schema::dropIfExists('control_nicaragua');
    }
}

...
class CreateControlGuatemalaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('control_guatemala', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('id_pep');
            $table->string('id_all')->nullable();
            $table->enum('type', [ControlGuatemala::PEP, ControlGuatemala::LISTA]);
    ...
    {
        Schema::dropIfExists('control_guatemala');
    }
}

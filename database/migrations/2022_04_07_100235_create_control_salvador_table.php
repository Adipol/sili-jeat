...
class CreateControlSalvadorTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('control_salvador', function (Blueprint $table) {
            $table->id();

            $table->bigInteger('id_pep');
            $table->string('id_all')->nullable();
            $table->enum('type', [ControlSalvador::PEP, ControlSalvador::LISTA]);
    ...
    {
        Schema::dropIfExists('control_salvador');
    }
}

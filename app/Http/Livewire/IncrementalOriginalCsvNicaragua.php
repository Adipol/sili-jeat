...
class IncrementalOriginalCsvNicaragua extends Component
{
    use WithFileUploads;
    ...
    public function mount(NicaraguaImport $control)
    {
    ...
    {
        return view('livewire.incremental-original-csv-nicaragua');
    }
}

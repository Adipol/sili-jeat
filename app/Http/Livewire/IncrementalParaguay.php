...
class IncrementalParaguay extends Component
{
    use WithFileUploads;
    ...
    {
        $controls = ParaguayImport::orderBy('id', 'desc')->take(5)->get();

        return view('livewire.incremental-paraguay', compact('controls'));
    }
    ...
    {
        $control = ParaguayImport::where('id', $id)->first();

...
class IncrementalOriginalCsvSalvador extends Component
{
    use WithFileUploads;
    ...
    public function mount(SalvadorImport $control)
    {
    ...
    {
        return view('livewire.incremental-original-csv-salvador');
    }
}

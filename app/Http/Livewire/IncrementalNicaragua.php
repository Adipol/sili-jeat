...
class IncrementalNicaragua extends Component
{
    use WithFileUploads;
    ...
    {
        $controls = NicaraguaImport::orderBy('id', 'desc')->take(5)->get();

        return view('livewire.incremental-nicaragua', compact('controls'));
    }
    ...
    {
        $control = NicaraguaImport::where('id', $id)->first();

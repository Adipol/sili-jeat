...
class IncrementalGuatemala extends Component
{
    use WithFileUploads;
    ...
    {
        $controls = GuatemalaImport::orderBy('id', 'desc')->take(5)->get();

        return view('livewire.incremental-guatemala', compact('controls'));
    }
    ...
    {
        $control = GuatemalaImport::where('id', $id)->first();

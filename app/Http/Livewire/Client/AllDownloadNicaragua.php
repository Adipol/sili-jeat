...
class AllDownloadNicaragua extends Component
{
    public $download_all;

    public $code = ['ASO-PEP', 'FBI', 'F-PEP', 'GAFI', 'INTERPOL', 'OFAC', 'ONU', 'OPI', 'PEP-EX', 'PEP-NAL', 'UE', 'PF-UE', 'ENGEL', 'UK', 'EUROPOL', 'CANADIENSES', 'EXP', 'IPR', 'DEA', 'UPA'];
    public $colors = [
        'ASO-PEP' => '#6a5bcdb8',
        'FBI' => '#708090',
        'F-PEP' => '#ff8c00c7',
    ...
    public function mount(NicaraguaWhole $download_all)
    {
        $this->download_all = $download_all;
    }
    public function render()
    {
        $expenses = ControlNicaragua::whereIn('code', $this->code)->get();
        ...
        return view('livewire.client.all-download-nicaragua')->with([
